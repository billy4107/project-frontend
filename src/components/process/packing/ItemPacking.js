        ...
        <div className="column">
            <div className="card list">
                <div className="card-body">
                    ...
                    <p className="card-text">จำนวน: {thecard.quantity} แพ็ค</p>
                    <p className="card-text">น้ำหนักสุทธิ: {thecard.netweight} กรัม</p>

                    <button type="button" className="btn btn-primary" onClick={() => { onSetPageAdd(thecard.proid) }} disabled={!thecard.quantity || !thecard.netweight}>Submit</button>
                    <span> | </span>
                    <Link to={`/pageprocess/packing/${thecard.proid}`} type="button" className="btn btn-primary" onClick={() => { setEdit(thecard) }}>Insert</Link>
                    <span> | </span>
